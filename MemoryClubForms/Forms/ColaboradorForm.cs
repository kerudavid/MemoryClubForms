...
namespace MemoryClubForms.Forms
{
    public partial class ColaboradorForm : Form
    {
        ...
        private bool ValidarInformacion()
        {
            ...
            {
                MessageBox.Show("Su usuario no tiene privilegios para ingresar o modificar Colaborador.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return false;
            }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (action == 1) //Insertar
                {
                    ...
                    colaboradorModel.Fecha_mod = DateTime.Now.ToString("MM/dd/yyyy", ci);
