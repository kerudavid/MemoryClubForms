...
namespace MemoryClubForms.Forms
{
    public partial class AlimentosForm : Form
    {
        ...
        private bool ValidarInformacion()
        {
            ...
            {
                MessageBox.Show("Su usuario no tiene privilegios para ingresar o modificar datos de Alimentos.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return false;
            }
            //Transportista
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            CleanData();
            if ((cbxFiltroNombreCliente.SelectedItem != null) || (cbxFiltroAlimentos.SelectedItem != null))
            {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (action == 1) //Insertar
                {
                    ...
                    alimentacionModel.Fecha_mod = DateTime.Now.ToString("MM/dd/yyyy", ci);

                    string responseDB = alimentacionBO.InsertarAlimentoR(alimentacionModel);
                ...
                else
                {
                    ...
                    string responseDB = alimentacionBO.ActualizarAlimentoR(alimentacionModel);
                    if (responseDB.ToLower() != "ok")
                    {
